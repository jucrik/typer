  ...
  const lightTheme = createTheme(
    {
      ...
      palette: {
        primary: { main: system.color.lightTheme.palette.primary || "#0066cc" },
        secondary: { main: system.color.lightTheme.palette.secondary || "#0066cc" },
        toolbar: { main: system.color.lightTheme.toolbar.background || "#0066cc" },
  ...
  const darkTheme = createTheme(
    {
      ...
      palette: {
        primary: { main: system.color.darkTheme.palette.primary || "#e8e8e8" },
        secondary: { main: system.color.darkTheme.palette.secondary || "#e8e8e8" },
        toolbar: { main: system.color.darkTheme.toolbar.background || "#e8e8e8" },
        ...
        text: {
          primary: system.color.darkTheme.palette.text.primary || "#e8e8e8",
