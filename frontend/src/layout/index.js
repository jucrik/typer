    ...
    <div className={classes.root}>
      ...
      >
        <Toolbar variant="dense" className={classes.toolbar}>
          ...
          >
            {i18n.t("mainDrawer.appBar.message.hi")} {user.name}, {i18n.t("mainDrawer.appBar.message.text")} {system.name || "Typer"}
          </Typography>
          ...
          <div>
            ...
            >
              ...
              <span className={classes.systemCss}>
                <Link color="inherit" href={system.url || "https://github.com/jucrik/typer"}>
                  v{systemVersion}
                </Link>
              </span>
            </Menu>
